...
{
//    Salam, Bu programdakı səhvləri bilirəm.Sadəcə  vaxt azlığından  çoxlu məhsul əlavə edə bilmədim.və satış olduğu zaman məhsulun
// sayından azalmır(mənim gördüklərim). 
//Sadəcə 2  gündə bacardığım budu.Belə gec başlamağımın səbəbi, Ayın 19 u ailədəki 2 nəfərin (3 nəfərik) corona testi Positive çıxdı.
//və ağır keçirirlər. Bütün yük üzərimə düşüb, az deyilmiş kimi BDU tələbəsi olaraq Son anda verilən qərara görə kollekvumlardan
//qiymət almalı imişik.İndi sağ olsunlar vəziiyəti izzah elədim az da olsa köməklik göstərdilər.Yazmağımın səbəbi daha gözəl iş bacara bilərdim
//sadəcə BU zamanda  bacardığım bu idi......
//Diqqətinizə görə TƏŞƏKKÜRLƏR.
//Bu arada Yeni iliniz mübarək.
//Program isə Məhsulu daxil edib sonra Satış etmək olur
        ...
        public void SatishELave(int n)
        {
            ...
            foreach (var item in Database.mehsuls)
            {
                if (n == item.kod)
                {
                    ...
                    //geriye donmek ucun
                    Console.WriteLine("1:Mehsul uzerinde emeliyyat");
                    Console.WriteLine("2:Satish uzerinde emelliyyat");
                    Console.WriteLine("3:Cixis");
                    int mehsul1 = Convert.ToInt32(Console.ReadLine());
                    Console.Clear();
